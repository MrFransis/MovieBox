package it.unipi.dii.dmml.moviebox.utils;
...
public class Utils {
    ...
    public static Properties readConfigurationParameters(){
        try{
            FileInputStream fis = new FileInputStream(Utils.class.getResource("/it/unipi/dii/dmml/moviebox/config/config.properties").toURI().getPath());
    ...
    public static void error() {
        Alert alert = new Alert(Alert.AlertType.ERROR, "Error: An error occurred.");
        alert.showAndWait();
    }
}
